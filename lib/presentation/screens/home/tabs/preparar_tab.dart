        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const _PrepararMainCard(),
              const SizedBox(height: 16),
              ApexFeatureCard(
                badge: 'GFX',
                title: 'Perfil da sessão',
                subtitle: 'Preferências locais serão aplicadas antes da partida.',
              ...
              ApexFeatureCard(
                ...
                subtitle: 'Rede, energia e foco serão revisados antes de jogar.',
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          'Configure sua partida antes de abrir o jogo.',
...
class _PrepararMainCard extends StatelessWidget {
  const _PrepararMainCard();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Em breve esta área reunirá perfil, diagnóstico e abertura do jogo.',
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  color: AppColors.textGray,
                  fontSize: 13,
                ),
