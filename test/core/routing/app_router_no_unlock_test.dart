...
void main() {
  ...
  test('appRouter no longer registers the /unlock route (MONETIZATION-PAID-U1)', () {
    expect(collectPaths(), isNot(contains('/unlock')));
  });

  test('core app routes remain accessible without any entitlement/unlock gating', () {
